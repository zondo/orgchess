...
# TODO: try making a game tree (what output options?)
# TODO: try creating SVG move diagrams
...
For a tangled solver script, we also need a main program to invoke:
...
#+begin_src python :tangle mate-in-2.py :results silent
  """
...
Finally, a test to see if it works.

#+begin_src sh
  python mate-in-2.py 5K2/3PRnQB/2p5/3p4/5k2/7q/2N5/4N3
#+end_src
